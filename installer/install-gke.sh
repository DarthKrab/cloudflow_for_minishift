...
# Create project 
oc new-project $CLOUDFLOW_NAMESPACE
oc create sa cloudflow-nfs -n $CLOUDFLOW_NAMESPACE
oc adm policy add-scc-to-user privileged system:serviceaccount:$CLOUDFLOW_NAMESPACE:cloudflow-nfs
